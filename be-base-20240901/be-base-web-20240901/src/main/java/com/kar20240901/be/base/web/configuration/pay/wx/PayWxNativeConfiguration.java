 ...
 */
@Configuration
public class PayWxNativeConfiguration implements IBasePay {
    ...
    public IBasePayType getBasePayType() {
        return BasePayTypeEnum.WX_NATIVE;
    }
    ...
    public BasePayTradeStatusEnum query(String outTradeNo, BasePayConfigurationDO basePayConfigurationDO) {
        return PayWxUtil.queryNative(outTradeNo, basePayConfigurationDO);
    }
