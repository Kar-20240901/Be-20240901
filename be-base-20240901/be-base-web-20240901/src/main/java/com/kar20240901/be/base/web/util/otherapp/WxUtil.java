package com.kar20240901.be.base.web.util.otherapp;
...
import com.kar20240901.be.base.web.model.enums.otherapp.WxMediaUploadTypeEnum;
import com.kar20240901.be.base.web.model.interfaces.base.IBaseQrCodeSceneType;
import com.kar20240901.be.base.web.model.vo.base.R;
import com.kar20240901.be.base.web.model.vo.otherapp.WxAccessTokenVO;
import com.kar20240901.be.base.web.model.vo.otherapp.WxBaseVO;
import com.kar20240901.be.base.web.model.vo.otherapp.WxOpenIdVO;
import com.kar20240901.be.base.web.model.vo.otherapp.WxPhoneByCodeVO;
import com.kar20240901.be.base.web.model.vo.otherapp.WxServiceStateVO;
import com.kar20240901.be.base.web.model.vo.otherapp.WxServicerListVO;
import com.kar20240901.be.base.web.model.vo.otherapp.WxSyncMsgVO;
import com.kar20240901.be.base.web.model.vo.otherapp.WxUnionIdInfoVO;
import com.kar20240901.be.base.web.model.vo.otherapp.WxUserInfoVO;
import com.kar20240901.be.base.web.model.vo.otherapp.WxWorkOpenIdVO;
...
public class WxUtil {
    ...
    private static BaseOtherAppService baseOtherAppService;

    public WxUtil(BaseOtherAppService baseOtherAppService) {

        WxUtil.baseOtherAppService = baseOtherAppService;
    ...
    public static WxOpenIdVO getWxMiniProgramOpenIdVoByCode(String code, @Nullable String appId) {
        ...
        BaseOtherAppDO baseOtherAppDO =
            baseOtherAppService.lambdaQuery().eq(StrUtil.isNotBlank(appId), BaseOtherAppDO::getAppId, appId)
                .eq(TempEntityNoId::getEnableFlag, true)
                .eq(BaseOtherAppDO::getType, BaseOtherAppTypeEnum.WX_MINI_PROGRAM)
        ...
        String jsonStr = HttpUtil.get(
            "https://api.weixin.qq.com/sns/jscode2session?appid=" + baseOtherAppDO.getAppId() + "&secret="
                + baseOtherAppDO.getSecret() + "&js_code=" + code + "&grant_type=authorization_code");

        log.info("微信小程序登录：{}", jsonStr);

        WxOpenIdVO wxOpenIdVO = JSONUtil.toBean(jsonStr, WxOpenIdVO.class);

        checkWxVO(wxOpenIdVO, errorMessageStr, baseOtherAppDO.getAppId()); // 检查：微信回调 vo对象
    ...
    public static String getAccessToken(String appId) {
        ...
        BaseOtherAppTypeEnum baseOtherAppTypeEnum = BaseOtherAppTypeEnum.WX_OFFICIAL_ACCOUNT;
