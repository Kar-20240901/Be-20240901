...
public class RedissonUtil {
    ...
    public static void doMultiLock(@Nullable String preName, Set<?> nameSet, @NotNull VoidFunc0 voidFunc0,
        ...
        doMultiLockSuf(preName, nameSet, null, voidFunc0, lockArr);
     ...
     */
    @SneakyThrows
    public static void doMultiLockSuf(@Nullable String preName, Set<?> nameSet, @Nullable String sufName,
        @NotNull VoidFunc0 voidFunc0, RLock... lockArr) {

        RLock lock = getMultiLock(preName, nameSet, sufName, lockArr);
    ...
    public static <T> T doMultiLock(@Nullable String preName, Set<?> nameSet, @NotNull Supplier<T> supplier,
        ...
        return doMultiLockSuf(preName, nameSet, null, supplier, lockArr);
     ...
     * 获取连锁，并执行方法
     */
    public static <T> T doMultiLockSuf(@Nullable String preName, Set<?> nameSet, @Nullable String sufName,
        @NotNull Supplier<T> supplier, RLock... lockArr) {
     ...
     * 获取连锁
     */
    private static RLock getMultiLock(@Nullable String preName, Set<?> nameSet, @Nullable String sufName,
        RLock... tempLockArr) {
        ...
        for (Object item : nameSet) {
            ...
            lockArr[i] = redissonClient.getLock(PRE_REDISSON + preName + item + sufName); // 设置锁名
