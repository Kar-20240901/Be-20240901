...
public interface IBasePay {
     ...
     * 支付方式类型
     */
    @NotNull IBasePayType getBasePayType();

    /**
     * 支付返回值，备注：一般返回 url
     */
    @NotNull BasePayReturnBO pay(PayDTO dto);

    /**
     * 查询订单状态
     */
    @NotNull BasePayTradeStatusEnum query(String outTradeNo, BasePayConfigurationDO basePayConfigurationDO);
