...
@AllArgsConstructor
@Getter
public enum BasePayTradeStatusEnum {
     ...
     */
    @NotNull
    public static BasePayTradeStatusEnum getByStatus(String status) {

        String toUpperCase = status.toUpperCase();

        for (BasePayTradeStatusEnum item : BasePayTradeStatusEnum.values()) {
